var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        $('#table-projects-new').click(function (e) {
            e.preventDefault();

            if (nNew && nEditing) {
                if (confirm("Предыдущий проект не сохранён. Хотите сохранить?")) {
        ...
        table.on('click', '.delete', function (e) {
            ...
            if (confirm("Вы действительно хотите удалить этот проект?") == false) {
                return;
            }

            var nRow = $(this).parents('tr')[0];

            $.post('/admin/projects/delete', { id : $(nRow).attr('id') }, function(res) {
